...
Clock.prototype.drawBase = function (ctx) {
  this.ctx.save();
  //時計の内側
...
Clock.prototype.drawFigure = function () {
  this.ctx.save();
  //文字の描画
...
Clock.prototype.drawHand = function (deg, obj) {
  this.ctx.save();
